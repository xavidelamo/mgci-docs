...
<qgis version="3.28.11-Firenze" maxScale="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories">
  <flags>
  ...
  <pipe>
    ...
    <rasterrenderer type="hillshade" azimuth="315" alphaBand="-1" multidirection="0" nodataColor="" zfactor="1" opacity="0.8" angle="45" band="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
    ...
    <huesaturation saturation="0" colorizeRed="255" grayscaleMode="0" colorizeOn="0" invertColors="0" colorizeStrength="100" colorizeGreen="128" colorizeBlue="128"/>
